...
function Library:create_ui()
    ...
    Pin.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
    Pin.Parent = Handler
    ...
    function self:create_tab(title: string, icon: string)
        ...
        function TabManager:create_module(settings: any)
            ...
            ModuleName.TextColor3 = Color3.fromRGB(255, 105, 180)
            ...
            Description.TextColor3 = Color3.fromRGB(255, 105, 180)
            ...
            Keybind.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
            ...
            function ModuleManager:create_feature(settings)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(255, 105, 180) or Color3.fromRGB(32, 38, 51)
                    Checkbox.Text = ""
